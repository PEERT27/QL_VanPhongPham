...
public class SanPhamDAO {
    ...
    public static void FindSP(String MAMH){
         String Name="";
            try{
    ...
    public static ArrayList<SanPhan>GetListSanPham1(String t){
        
        ArrayList<SanPhan>dsPBan =new ArrayList<SanPhan>();
        try{
            ...
            pro.getCn();
             ResultSet rs= pro.executeQuery(sql);
            while(rs.next()){
              SanPhan sp =new SanPhan();
              sp.setMaSP(rs.getString("MAMH"));
              sp.setTenSP(rs.getString("TENMH"));
